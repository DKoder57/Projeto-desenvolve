...
INSERT INTO `aluno` VALUES ('A001','João Silva','2000-05-20','Rua das Flores, 123'),('A002','Maria Oliveira','1999-11-10','Av. Brasil, 456');
...
INSERT INTO `avaliacao` VALUES ('12345678901','2023-09-01 10:00:00','Excelente explicação',9),('98765432100','2023-09-02 14:30:00','Boa didática',8);
...
INSERT INTO `departamento` VALUES (1,'Ciência da Computação'),(2,'Matemática'),(3,'Física');
...
INSERT INTO `disciplina` VALUES ('Algoritmos',60,'Introdução à lógica de programação'),('Cálculo I',45,'Funções, limites e derivadas');
...
CREATE TABLE `professor` (
  ...
  `nome` varchar(255) NOT NULL,
  `inicio_contato` date DEFAULT NULL,
...
INSERT INTO `professor` VALUES ('12345678901','Ana Souza','2020-02-15',1),('98765432100','Carlos Lima','2019-08-01',2);
...
INSERT INTO `professor_contato` VALUES ('12345678901','31999990000'),('98765432100','31988887777');
...
-- Dump completed on 2025-10-01 12:43:25
